...
Apr 26, 2026, 2:36 PM GMT+8  提交的是完全体可用，另附：电机RS02和3508以及2006在部分程序里已完成角度转化，两个EL05暂时未动。角度转化规则详细见电机记录txt文本
...
|------|----------|----------|---------|------|
| Joint 0 | RobStride 02 | CAN1 | 0x01 | 底座旋转 |
| Joint 1 | RM3508 | CAN1 | 0x201 | 抬升 |
| Joint 2 | M2006 | CAN2 | 0x202 | 伸长 |
| Joint 3 | RobStride EL05 | CAN2 | 0x02 | 腕部旋转 |
| Joint 4 | RobStride EL05 | CAN2 | 0x03 | 末端执行器 |

### 硬件连接

- **CAN1**: 连接 RM3508 和 云台RS02 电机
- **CAN2**: 连接 线缆进入拖链的电机/末端三电机
- **USB**: 与上位机通信 (CDC 虚拟串口)
